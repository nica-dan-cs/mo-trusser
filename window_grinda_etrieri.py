...
class window_placa(window):
	...
	def add_to_file(self,name,location):
		...
		self.all_written["Nr bare + ɸ "].append(ceva[0])
		self.all_written["Mcap [kNm]"].append(round(ceva[1],2))
		self.all_written["ρ [‰]"].append(round(ceva[2]*1000,3))
 	...
 	#destroys radio buttons
		...
		for s in all_solutions:
			...
			#radio button		
				...
				self.to_be_written_csv[v]=str(str(s[1])+" ɸ "+ str(int(s[0]))),M_cap,Rho
